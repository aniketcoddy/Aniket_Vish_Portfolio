            ...
            <div>
                ...
                <div >
                    <ul className='flex gap-10 sm:gap-3 ml-24 lg:justify-center lg:ml-0'>
                        <li className='text-base font-medium px-5 p-1 shadow-inner shadow-[#00ADB5] font-[Roboto] text-[#EEEEEE] sm:text-xs xxs:text-[9px] backdrop-blur-lg rounded-2xl hover:cursor-pointer bg-black' ref={ref} onClick={handleAll} >All</li>
