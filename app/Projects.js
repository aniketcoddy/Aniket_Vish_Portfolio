...
function Projects() {
    ...
    return (
        <div className=" flex flex-col h-fit mt-36 lg:mt-24 mb-24 pb-24" style={myStyle} id='projects'>
            <div>
                <div className='flex gap-4 m-20 sm:m-16 lg:justify-center'>
                    <h1 className='3xl:text-6xl 4xl:text-7xl text-8xl font-semibold text-[#EEEEEE] sm:text-4xl font-[Roboto]'>My</h1>
                    <h1 className='3xl:text-6xl 4xl:text-7xl text-8xl font-semibold text-[#00ADB5] sm:text-4xl font-[Roboto]'>Projects</h1>
                </div>
                <div >
                    <ul className='flex gap-10 sm:gap-3 ml-24 lg:justify-center lg:ml-0'>
                        <li className='3xl:text-base text-4xl font-medium px-5 p-1 shadow-inner shadow-[#00ADB5] font-[Roboto] text-[#EEEEEE] sm:text-xs xxs:text-[9px]
                         backdrop-blur-lg rounded-2xl hover:cursor-pointer bg-black' ref={ref} onClick={handleAll} >All</li>
                        <li className='3xl:text-base text-4xl font-medium px-5 p-1 shadow-inner shadow-[#00ADB5] font-[Roboto] text-[#EEEEEE] sm:text-xs xxs:text-[9px] bg-[#393E46] backdrop-blur-lg rounded-2xl hover:cursor-pointer' ref={ref1} onClick={handleReact} >React Js</li>
                        <li className='3xl:text-base text-4xl font-medium px-5 p-1 shadow-inner shadow-[#00ADB5] font-[Roboto] text-[#EEEEEE] sm:text-xs xxs:text-[9px] bg-[#393E46] backdrop-blur-lg rounded-2xl hover:cursor-pointer' ref={ref2} onClick={handleNext} >Next Js</li>
                        <li className='3xl:text-base text-4xl font-medium px-5 p-1 shadow-inner shadow-[#00ADB5] font-[Roboto] text-[#EEEEEE] sm:text-xs xxs:text-[9px] bg-[#393E46] backdrop-blur-lg rounded-2xl hover:cursor-pointer' ref={ref3} onClick={handleJs} >Javascript</li>
                    </ul>
                </div>
                ...
                <div>
                    <div>
                        {all ? "" : (
                            <div className='flex flex-wrap 3xl:mt-9 mt-14 sm:ml-0 sm:justify-center ml-40'>
                                <ProjectCard image="/portfolio.png" git="https://github.com/aniketcoddy/Aniket_Vish_Portfolio.git" launch="https://portfolioforaniket.netlify.app/" name="My Portfolio" topic="Website" description="You are now browsing my portfolio page, which contains all of my personal data.I utilised the Next js javascript framework, the Tailwind CSS framework, and basic html in my project." />
                                ...
                                <ProjectCard image="/LoginPage.png" git="https://github.com/aniketcoddy/Form-Validation-.git" launch="https://form-validationsite.netlify.app/" name="Login/Signup" topic="Authentication" description="This is a simple registration form that ensures accurate entering of information after being run using regular expression.Tech used is ES6 Javascript, vanila Css and HTML5" />
                        ...
                        {next ? "" : (
                            <div className='flex flex-wrap mt-9 sm:ml-0 sm:justify-center ml-40'>
                                <ProjectCard image="/portfolio.png" git="https://github.com/aniketcoddy/Aniket_Vish_Portfolio.git" launch="https://portfolioforaniket.netlify.app/" name="My Portfolio" topic="Website" description="You are now browsing my portfolio page, which contains all of my personal data.I utilised the Next js javascript framework, the Tailwind CSS framework, and basic html in my project." />
                                <ProjectCard image="/NextTOdo.png" git="https://github.com/aniketcoddy/Aniket_Vsihnoi_TODO_NextJs.git" launch="https://aniketvishnoinextjstodoapp.netlify.app" name="Task Organizer" topic="ToDo list" description="This advance task manager allows you to record your daily to-dos and delete or update them as soon as they are completed.I utilised the Next js javascript framework, the Tailwind CSS framework, and Local Storage" />
                            </div>
                        )}
